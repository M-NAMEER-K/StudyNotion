    ...
    <div className=" w-full  flex flex-col ">
      ...
      <div className="flex w-full flex-wrap gap-y-2">
        ...
        {chips.map((chip, index) => (
          <div
            key={index}
            className="m-1 flex items-center rounded-full bg-yellow-400 px-2 py-1 text-sm text-white-5"
          >
        ...
        <input
          ...
          className="form-style w-full bg-white text-black rounded outline-0"
        />
